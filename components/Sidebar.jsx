    ...
    <>
      ...
      <aside className="hidden lg:flex fixed left-0 top-0 h-screen w-64 bg-sidebar text-sidebar-foreground flex-col border-r border-sidebar-border z-40">
        ...
        <div className="p-6 border-b border-sidebar-border flex items-center gap-3">
          <img src="/Logo/ncip-office-logo.png" alt="NCIP Office on Policy, Planning & Research" className="w-16 h-16 object-contain rounded-md" />
          <div>
            <h1 className="text-sm font-semibold">NCIP Office on Policy, Planning & Research</h1>
          </div>
        </div>
      ...
      >
        ...
        <div className="p-6 border-b border-sidebar-border flex items-center justify-between">
          <div>
            <h1 className="text-lg font-semibold">NCIP Office on Policy, Planning & Research</h1>
          </div>
